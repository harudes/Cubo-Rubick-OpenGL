...
RubickCube::RubickCube(glm::vec3 center, GLfloat arista, GLfloat offset, GLuint shaderProgram, std::string colors):cubitos(27,nullptr){
	...
	cubitos[11] = new Cube(glm::vec3((centerX - arista - offset), (centerY - arista - offset), (centerZ + arista + offset)), arista, { BLACK,getCharColor(colors[getDuplePosition("U7")]),getCharColor(colors[getDuplePosition("L1")]),BLACK,getCharColor(colors[getDuplePosition("B3")]),BLACK }, shaderProgram);//B3, L1, U7
	...
	cubitos[14] = new Cube(glm::vec3((centerX - arista - offset), centerY, (centerZ + arista + offset)), arista, { BLACK,getCharColor(colors[getDuplePosition("U2")]),BLACK,BLACK,getCharColor(colors[getDuplePosition("B8")]),BLACK }, shaderProgram);//U2, B8
	...
	cubitos[16] = new Cube(glm::vec3(centerX, (centerY + arista + offset), (centerZ + arista + offset)), arista, { BLACK,getCharColor(colors[getDuplePosition("U8")]),BLACK,getCharColor(colors[getDuplePosition("R2")]),BLACK,BLACK }, shaderProgram);//R2, U8
	cubitos[17] = new Cube(glm::vec3((centerX - arista - offset), (centerY + arista + offset), (centerZ + arista + offset)), arista, { BLACK,getCharColor(colors[getDuplePosition("U7")]),BLACK,getCharColor(colors[getDuplePosition("R3")]),getCharColor(colors[getDuplePosition("B1")]),BLACK }, shaderProgram);//R3, B1, U7
	...
	cubitos[19] = new Cube(glm::vec3(centerX, (centerY - arista - offset), (centerZ - arista - offset)), arista, { getCharColor(colors[getDuplePosition("D2")]),BLACK,getCharColor(colors[getDuplePosition("L8")]),BLACK,BLACK,BLACK }, shaderProgram);//L8, D2
	cubitos[20] = new Cube(glm::vec3((centerX - arista - offset), (centerY - arista - offset), (centerZ - arista - offset)), arista, { getCharColor(colors[getDuplePosition("D3")]),BLACK,getCharColor(colors[getDuplePosition("L7")]),BLACK,getCharColor(colors[getDuplePosition("B9")]),BLACK }, shaderProgram);//L7, B9, D3
	...
	cubitos[23] = new Cube(glm::vec3((centerX - arista - offset), centerY, (centerZ - arista - offset)), arista, { getCharColor(colors[getDuplePosition("D2")]),BLACK,BLACK,BLACK,getCharColor(colors[getDuplePosition("B8")]),BLACK }, shaderProgram);//B8, D2
	...
	cubitos[26] = new Cube(glm::vec3((centerX - arista - offset), (centerY + arista + offset), (centerZ - arista - offset)), arista, { getCharColor(colors[getDuplePosition("D1")]),BLACK,BLACK,getCharColor(colors[getDuplePosition("R9")]),getCharColor(colors[getDuplePosition("B7")]),BLACK }, shaderProgram);//R9, B7, D1
